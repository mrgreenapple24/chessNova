...
/**
 * @brief Table of 781 pseudo-random 64-bit keys used specifically for
 * generating Polyglot Zobrist hashes.
 *
 ...
 * - 773 to 780: En passant file (files A-H, only if a double pawn push occurs
 * and a capturing pawn is adjacent)
 */
